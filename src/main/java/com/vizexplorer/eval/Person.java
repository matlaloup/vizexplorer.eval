...
public class Person
{
  ...
  /**
   * This implementation has been generated by Eclipse. In my opinion, it serves
   * the purpose as long as it is NOT for an end user but mainly for debug
   * purposes. For example the date should be properly formatted using
   * SimpleDateFormat.
   */
  @Override
